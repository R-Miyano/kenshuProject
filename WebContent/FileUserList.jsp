									...
									<%@ page import="java.time.LocalTime" %>
										<%@ page import="java.time.format.DateTimeFormatter" %>
											<%@ page import="java.util.Arrays" %>
												...
												<head>
													...
													<script type="text/javascript">
														...
														function goPage(p) {
															...
															document.getElementById('selectedIds').value = merged.join(',');
												...
												<body>
													<% int pageNo=Integer.parseInt(webBean.txt("pageNo", 1)); int
														maxPageNo=Integer.parseInt(webBean.txt("maxPageNo", 1)); %>
																	...
																	<div id="main">
																		...
																		<div class="file__form--name">
																			...
																			<div class="user-container">
																				<% String
																					sel=webBean.value("selectedIds"); if
																					(sel==null) sel="" ; List<String>
																					stay =
																					Arrays.asList(sel.split(","));
																					for (Object o :
																					webBean.arrayList("user_data")) {
																					...
																					<% } %>
																						<% if
																							(webBean.arrayList("user_data").isEmpty())
																							{ %>
																							<p>送信先ユーザーがありません</p>
																							<% } %>
