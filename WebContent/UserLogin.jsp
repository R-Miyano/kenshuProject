                ...
                <div id="contents">
                  <div id="main">
                    ...
                    <div class="main__text">
                      <p style="margin-top: 10px; margin-bottom: 5px;">usernameとpasswordを入力してください</p>
                      <div style="color: red; font-weight: bold; min-height: 1.2em; margin-bottom: 5px;">
                        <%=webBean.dispError("ac", false)%>
                        <%=webBean.dispError("ko", false)%>
                      </div>
                    </div>
                    <form method="post" id="main_form" action="" class="main__form">
                      ...
                      <div class="main__form--name">
                        <input type="text" id="ac" name="ac" class="ime_disabled" value="<%=webBean.txt(" ac")%>"
                        placeholder="Username" size="25" maxlength="255" />
                      </div>
                      <div class="main__form--password">
                        <input type="password" id="ko" name="ko" class="ime_disabled" value="" placeholder="Password"
                          size="25" maxlength="60" />
                      </div>
                      <div class="main__form--btn">
                        <input type="submit" id="bt" name="login-btn" onclick="go_submit('login')" class="submit-btn"
                          value="ログイン" />
                      </div>
                      <div class="main__form--link">
                        <a href="#" id="reissue" onclick="go_submit_1('repassword'); return false;" class="link-btn">パスワードを忘れた方はこちら</a>
                      </div>
                    </form>
