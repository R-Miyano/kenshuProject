...
public class ReserveFileDao implements Serializable {
    ...
    public void setReserveFileDao(HashMap<String, String> map, ReserveFileDao dao) throws AtareSysException {
        dao.setReserveFileId(map.getOrDefault("reserve_file_id", ""));
    ...
    public void setReserveFileDaoForJoin(HashMap<String, String> map, ReserveFileDao dao) throws AtareSysException {
        dao.setReserveFileId(map.getOrDefault("reserve_file___reserve_file_id", ""));
        dao.setReserveId(map.getOrDefault("reserve_file___reserve_id", ""));
        dao.setFileId(map.getOrDefault("reserve_file___file_id", ""));
    }
    ...
    public static ArrayList<ReserveFileDao> dbSelectList(ReserveFileDao myclass, LinkedHashMap<String, String> sortKey,
    ...
    public boolean deleteFile(String fileId) throws AtareSysException {
        ...
        try (Connection conn = (Connection) DbBase.getDbConnection();
            ...
            if (ret != 1)
                throw new AtareSysException("Delete operation affected an unexpected number of records.");
        } catch (SQLException e) {
