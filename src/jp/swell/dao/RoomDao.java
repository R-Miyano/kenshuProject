...
public class RoomDao implements Serializable {
    ...
    public void setRoomDao(HashMap<String, String> map, RoomDao dao) throws AtareSysException {
        ...
        dao.setRoomName(map.getOrDefault("room_name", ""));
    ...
    public void setRoomDaoForJoin(HashMap<String, String> map, RoomDao dao) throws AtareSysException {
        dao.setRoomId(map.getOrDefault("room___room_id", ""));
        dao.setRoomName(map.getOrDefault("room___room_name", ""));
        dao.setInsertDate(map.getOrDefault("room___insert_date", ""));
        dao.setInsertUserId(map.getOrDefault("room___insert_user_id", ""));
        dao.setUpdateDate(map.getOrDefault("room___update_date", ""));
        dao.setUpdateUserId(map.getOrDefault("room___update_user_id", ""));
    }
