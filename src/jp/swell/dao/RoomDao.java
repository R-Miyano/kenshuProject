...
public class RoomDao implements Serializable
{
    ...
    public ArrayList<String> getAuthorityUserList() { return authorityUserList; }
    ...
    public String getInsertUserId() { return insertUserId; }
    public void setInsertUserId(String insertUserId) { this.insertUserId = insertUserId; }
    ...
    public String getInputRemark() { return inputRemark; }
    public void setInputRemark(String inputRemark) { this.inputRemark = inputRemark; }
